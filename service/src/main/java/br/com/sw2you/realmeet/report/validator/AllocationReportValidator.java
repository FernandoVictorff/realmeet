...
public class AllocationReportValidator extends AbstractReportValidator {
    ...
    protected void validate(AbstractReportData reportData, ValidationErrors validationErrors) {
        ...
        ValidatorUtils.validateRequired(allocationReportData.getDateFrom(), DATE_FROM, validationErrors);
        ValidatorUtils.validateRequired(allocationReportData.getDateTo(), DATE_TO, validationErrors);
